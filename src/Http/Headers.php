...
class Headers
{
     ...
     * @param array $globals
     */
    final public function __construct($headers = [], $globals = null)
    {
        $this->globals = isset($globals) ? $globals : $_SERVER;
    ...
    {
        list($values, $originalName, $normalizedName) = $this->prepareHeader($name, $value);
     ...
     * {@inheritdoc}
     */
    public function getHeaders($originalCase = false)
    {
        $headers = [];
     ...
     * @return string
     */
    protected function normalizeHeaderName($name, $preserveCase = false)
    {
        $name = strtr($name, '_', '-');
     ...
     * @return array
     */
    protected function parseAuthorizationHeader($headers)
    {
     ...
     * @return array
     */
    protected function trimHeaderValue($value)
    {
